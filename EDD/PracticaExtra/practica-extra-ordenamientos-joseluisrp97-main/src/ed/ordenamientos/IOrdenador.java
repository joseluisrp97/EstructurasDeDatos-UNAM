...
/**
 * Interfaz que representa las acciones que debe realizar cualquier objeto capaz
 * de ordenar los elementos en un arreglo.
 *
 * @author blackzafiro
 */
public interface IOrdenador<C extends Comparable<C>> {
	 ...
	 *
	 * @param tam La longitud del arreglo a generar.
	 * @return Arreglo con el mejor caso para el algoritmo de ordenamiento
	 * implementado.
	 */
