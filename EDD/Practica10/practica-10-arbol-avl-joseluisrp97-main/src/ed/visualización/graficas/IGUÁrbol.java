...
public class IGUÁrbol extends Group {
	...
	/**
	 * Auxiliar para crear el tipo de nodo que visualizará el contenido del nodo
	 * del árbol.
	 *
	 * @param nodo
	 * @return IGUNodoÁrbol o una subclase suya.
	 */
	protected IGUNodoÁrbol creaIGUNodo(NodoBinario<?> nodo) {
		return new IGUNodoÁrbol(nodo);
	}
	...
	private IGUNodoÁrbol armaÁrbol(Pane padre, NodoBinario<?> nodo) {
		IGUNodoÁrbol iguNodo = creaIGUNodo(nodo);
