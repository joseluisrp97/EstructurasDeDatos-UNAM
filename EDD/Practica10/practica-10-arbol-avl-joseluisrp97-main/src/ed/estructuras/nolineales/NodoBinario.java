...
public interface NodoBinario<E> {
	 ...
	 * @throws NullPointerException si <code>dato</code> es
	 *         <code>null</code>.
	 */
	 ...
	 * @param hijoI Nodo hijo izquierdo, debe ser de la misma clase que esta instancia.
	 ...
	 * @param hijoD Nodo hijo derecho, debe ser de la misma clase que esta instancia.
	...
	/**
	 * Actualiza el valor de la altura de este nodo, asumiendo que el altura
	 * que reportan sus hijos es correcta.
