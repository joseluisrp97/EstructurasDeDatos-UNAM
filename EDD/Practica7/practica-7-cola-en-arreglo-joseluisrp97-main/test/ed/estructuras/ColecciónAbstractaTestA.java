...
public abstract class ColecciónAbstractaTestA extends Calificador {
	...
	public void constructorIllegalWithSizeTest() {
		...
		if (allowDifferentConstructor) {
			startTest(
					"Revisa que se lance IllegalArgumentException si el parámetro arreglo en el constructor tiene longitud distinta de cero",
					1.0, "Otros");
	...
	public void addSizeTest() {
		...
		startTest(
				"Revisa que la estructura mantenga la cantidad correcta de elementos, ademas de no estar vacía tras insertar con add(E)",
				1.0, "Inserción");
	...
	public void addAllContainsTest() {
		...
		startTest("Revisa que la estructura contenga todos los elementos insertados por addAll(Collection<?>)", 1.0,
				"*All");
	...
	public void addAllSizeTest() {
		...
		startTest(
				"Revisa que la estructura contenga la cantidad esperada de elementos insertados por addAll(Collection<?>)",
				1.0, "*All");
	...
	public void addAllNullPointerTest() {
		...
		startTest("Revisa que se lance NullPointerException si el parámetro es null en addAll(Collection<?>)", 1.0,
				"*All");
	...
	public void addAllIllegalArgumentTest() {
		...
		startTest(
				"Revisa que se lance IllegalArgumentException si el parámetro es la misma colección en addAll(Collection<?>)",
				1.0, "*All");
	...
	public void clearSizeTest() {
		...
		startTest("Revisa que la cantidad de elementos sea 0 y la estructura este vacía tras invocar clear()", 1.0,
				"Borrado");
	...
	public void containsAllTest() {
		...
		startTest(
				"Revisa que dos estructuras con los mismos elementos contengan todos los elementos de la otra estructura con containsAll(Collection<?>)",
				1.0, "*All");
	...
	public void containsAllItselfTest() {
		...
		startTest("Revisa que containsAll(Collection<?>) devuelva verdadero cuando el parámetro es la estructura misma",
				1.0, "*All");
	...
	public void containsAllInitTest() {
		...
		startTest("Revisa que dos estructuras vacías tengan los mismos elementos con containsAll(Collection<?>)", 1.0,
				"*All");
	...
	public void equalsTest() {
		...
		startTest(
				"Revisa la igualdad con equals(Object) para el orden y cantidad de elementos para dos estructuras no vacías equivalentes",
				1.0, "Otros");
	...
	public void equalsObjectTest() {
		...
		startTest("Revisa la desigualdad con equals(Object) de una estructura con algo que no es una estructura", 1.0,
				"Otros");
	...
	public void iteratorContainsTest() {
		...
		startTest(
				"Revisa que los elementos devueltos por el iterador sean los mismos que los insertados, no necesariamente en el mismo orden",
				1.0, "Búsqueda");
	...
	public void iteratorSizeTest() {
		...
		startTest(
				"Revisa que el número de elementos devueltos por el iterador sea el mismo al número de elementos en la estructura",
				1.0, "Búsqueda");
	...
	public void iteratorNoElementExceptionTest() {
		...
		startTest("Revisa que next() del iterador lance NoSuchElementException cuando la estructura no tiene elementos",
				1.0, "Búsqueda");
	...
	public void iteratorRemoveNoNextTest() {
		...
		if (allowIteratorRemove) {
			startTest(
					"Revisa que en el iterador lance IllegalStateException si se intenta invocar remove() sin invocar next()",
					1.0, "Búsqueda");
	...
	public void iteratorRemoveUnsupportedTest() {
		...
		if (!allowIteratorRemove) {
			startTest(
					"Revisa que remove del iterador lance UnsupportedOperationException si remove() del iterador no se permite",
					1.0, "Búsqueda");
	...
	public void removeContainsTest() {
		...
		if (allowRemove) {
			startTest("Prueba que la estructura no contenga elementos después de borrarlos con remove(E)", 1.0,
					"Borrado");
	...
	public void removeEmptyTest() {
		...
		if (allowRemove) {
			startTest("Revisa que se devuelva falso cuando se intenta borrar con remove(E) y no hay elementos", 1.0,
					"Borrado");
	...
	public void removeUnsupportedTest() {
		...
		if (!allowRemove) {
			startTest("Revisa que remove(E) lance UnsupportedOperationException si remove(E) no se permite", 1.0,
					"Borrado");
	...
	public void removeAllContainsTest() {
		...
		if (allowRemoveAll) {
			startTest("Revisa que la estructura no contenga ningún elemento borrado por removeAll(Collection<?>)", 2.0,
					"*All");
	...
	public void removeAllSizeTest() {
		...
		if (allowRemoveAll) {
			startTest(
					"Revisa que la estructura este vacía y con cero elementos tras usar removeAll(Collection<E>) con una estructura equivalente",
					1.0, "*All");
	...
	public void removeAllNullPointerTest() {
		...
		if (allowRemoveAll) {
			startTest("Revisa que removeAll(Collection<E>) lance NullPointerException si el parámetro es null", 1.0,
					"*All");
	...
	public void removeAllItselfTest() {
		...
		if (allowRemoveAll) {
			startTest(
					"Revisa que la estructura este vacía y con cero elementos tras usar removeAll(Collection<E>) con ella misma",
					1.0, "*All");
	...
	public void removeAllItselfEmptyTest() {
		...
		if (allowRemoveAll) {
			startTest(
					"Revisa que la estructura este vacía y con cero elementos tras usar removeAll(Collection<E>) con ella misma y devuelva false si estaba vacía",
					1.0, "*All");
	...
	public void removeAllUnsupportedTest() {
		...
		if (!allowRemoveAll) {
			startTest(
					"Revisa que removeAll(Collection<E>) lance UnsupportedOperationException si removeAll(Collection<E>) no se permite",
					1.0, "*All");
	...
	public void retainAllContainsTest() {
		...
		if (allowRetainAll) {
			startTest("Revisa que retainAll(Collection<E>) no haga cambios entre dos estructuras equivalentes", 1.0,
					"*All");
	...
	public void retainAllDontContainsTest() {
		...
		if (allowRetainAll) {
			startTest("Revisa que retainAll(Collection<E>) borre todos los elementos entre dos estructuras diferentes",
					1.0, "*All");
	...
	public void retainAllNullPointerTest() {
		...
		if (allowRetainAll) {
			startTest("Revisa que retainAll(Collection<?>) lance NullPointerException si el parámetro es null", 1.0,
					"*All");
	...
	public void retainAllItselfTest() {
		...
		if (allowRetainAll) {
			startTest(
					"Revisa que retainAll(Collection<E>) mantenga la cantidad de elementos si el parámetro es la misma estructura",
					1.0, "*All");
	...
	public void retainAllEmptyTest() {
		...
		if (allowRetainAll) {
			startTest(
					"Revisa que se borren todos los elementos si el parámetro de retainAll(Collection<E>) es una estructura vacía",
					1.0, "*All");
	...
	public void retainAllUnsupportedTest() {
		...
		if (!allowRetainAll) {
			startTest(
					"Revisa que retainAll(Collection<E>) lance UnsupportedOperationException si retainAll(Collection<E>) no se permite",
					1.0, "*All");
	...
	public void zeroSizeTest() {
		...
		startTest("Revisa que al inicializar la estructura la cantidad de elementos devuelta por size() sea cero", 1.0,
				"Otros");
	...
	public void toObjectArrayContainsTest() {
		...
		startTest("Revisa que el orden de los elementos devueltos por toArray() sea el mismo que el del iterador", 1.0,
				"Otros");
	...
	public void toObjectArraySizeTest() {
		...
		startTest(
				"Revisa que el número de elementos devueltos por toArray() sea el mismo que el que devuelve el iterador",
				1.0, "Otros");
	...
	public void toGenericArrayContainsTest() {
		...
		startTest("Revisa que el orden de los elementos devueltos por toArray(E[]) sea el mismo que el del iterador",
				1.0, "Otros");
	...
	public void toGenericArraySizeTest() {
		...
		startTest("Revisa que el número de elementos devueltos por toArray(E[]) sea el mismo que el del iterador", 1.0,
				"Otros");
	...
	public void toGenericArrayZeroSizeTest() {
		...
		startTest(
				"Revisa que el número de elementos de toArray(E[]) sea correcto cuando el arreglo pasado es de menor longitud al tamaño de la estructura",
				1.0, "Otros");
	...
	public void toGenericArrayNullFillTest() {
		...
		startTest(
				"Revisa que toArray(E[]) devuelva elementos null cuando la longitud del arreglo es mayor al número de elementos en la estructura",
				1.0, "Otros");
