...
//	}
	...
	public static void escribeOperaciones(String archivo, int par, long ops) throws FileNotFoundException {//escribimos en la pokedex y recibe de parametro una cadena para ahi meter el toString de cada pokemon

    }

	public static void escribeOperaciones2(String archivo, int par1, int par2, long ops) throws FileNotFoundException {
