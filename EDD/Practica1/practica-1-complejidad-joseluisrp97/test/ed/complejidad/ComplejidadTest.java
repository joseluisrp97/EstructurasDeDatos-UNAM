...
public class ComplejidadTest extends Calificador {
	...
	/**
	 * Test de tPascalRec, de clase Complejidad.
	 * @author José Luis Raya Pérez
	 */	
	@Test
	public void testTPascalRecYo() {
		startTest("tPascalRecYo", 1.0);
		assertEquals(1, c.tPascalRec(5, 5));
		addUp(1.0);
		passed();
	}
	/**
	 * Test de tPascalIt, de clase Complejidad.
	 * @author José Luis Raya Pérez
	 */

	@Test
	public void testTPascalItYo() {
		startTest("tPascalItYo", 1.0);
		assertEquals(1, c.tPascalIt(5, 5));
		addUp(1.0);
		passed();
	}
	/**
	 * Test de fibonacciRec, de clase Complejidad.
	 * @author José Luis Raya Pérez
	 */
	@Test
	public void testFibonacciRecYo() {
		startTest("fibonacciRecYo", 1.0);
		assertEquals(1, c.fibonacciRec(1));
		addUp(1.0);
		passed();
	}

	/**
	 * Test de fibonacciIt, de clase Complejidad.
	 * @author José Luis Raya Pérez
	 */
	@Test
	public void testFibonacciItYo() {
		startTest("fibonacciItYo", 1.0);
		assertEquals(0, c.fibonacciIt(0));
		addUp(1.0);
		passed();
	}
